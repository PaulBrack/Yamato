...
namespace MzmlParser.Test
{
    ...
    public class MzmlReaderTests
    {
        ...
        public static void Initialize(TestContext _)
        {
            ...
            run = reader.LoadMzmlAndRunPipeline(Path.Combine("mzmls", "test.mzml"), analysisSettings);
        }
        ...
        public void CorrectNumberOfMs2ScansAreLoaded()
        {
            ...
            Assert.AreEqual(65, run.Ms2ScanCount);
        }
        ...
        {
            Assert.AreEqual(1, run.Ms1Scans[0].Cycle);
            Assert.AreEqual(1, run.Ms2Scans[0].Cycle);
            Assert.AreEqual(1, run.Ms2Scans[50].Cycle);
        ...
        {
            Assert.AreEqual(false, run.Ms1Scans.Any(x => x.MsLevel != TandemMsLevel.Ms1));
            Assert.AreEqual(false, run.Ms2Scans.Any(x => x.MsLevel != TandemMsLevel.Ms2));
        }
