...
namespace SwaMe
{
    class FileMaker
    {
        ...
        public FileMaker(int division, string inputFilePath, MzmlParser.Run run, SwathGrouper.SwathMetrics swathMetrics, RTGrouper.RTMetrics rtMetrics, double RTDuration, double swathSizeDifference, int MS2Count, double cycleTimes50, double cycleTimesIQR, int totalMS2IonCount, int MS2Density50, int MS2DensityIQR, int MS1Count, string date)
        {
        ...
        {
            //tsv
            StreamWriter streamWriter = new StreamWriter(date +"_MetricsBySwath_" + run.SourceFileName + ".tsv");
        ...
        {
            string metricsPerRTSegmentFile = date+ "_RTDividedMetrics_" + run.SourceFileName+ ".tsv";
        ...
        {
            string undividedFile = date + "_undividedMetrics_" + run.SourceFileName + ".tsv";
        ...
        public void MakeiRTmetricsFile(Run run)
        {
            ...
            StreamWriter streamWriter = new StreamWriter(date  + "iRTMetrics_"  + run.SourceFileName +".tsv");
