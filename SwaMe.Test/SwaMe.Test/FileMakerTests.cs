...
namespace SwaMe.Test
{
    ...
    public class FileMakerTests
    {
        ...
        public void SwathMetricsFileCorrect()
        {
            ...
            var fileText = File.ReadLines(Path.Combine(Path.GetTempPath(),"SwaMe_results", "File1", "Today_MetricsBySwath_File1.tsv"));
        ...
        public void RTMetricsFileCorrect()
        {
            ...
            var fileText = File.ReadLines(Path.Combine(Path.GetTempPath(), "SwaMe_results", "File1", "Today_RTDividedMetrics_File1.tsv"));
        ...
        public void UndividedFileCorrect()
        {
            ...
            var fileText = File.ReadLines(Path.Combine(Path.GetTempPath(), "SwaMe_results", "File1", "Today_undividedMetrics_File1.tsv"));
        ...
        {
            var fileText = File.ReadLines(Path.Combine(Path.GetTempPath(), "SwaMe_results", "File1", "Today_iRTMetrics_File1.tsv"));
        ...
        {
            List<string> fileText = File.ReadLines(Path.Combine(Path.GetTempPath(), "SwaMe_results", "File1", "metrics_File1.json")).ToList();
