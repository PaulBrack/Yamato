...
namespace SwaMe.Test
{
    ...
    public class ChromatogramMetricGeneratorTest
    {
        ...
        public void IntensitiesCorrectIfOneBasePeak()
        {
            ...
            Assert.IsTrue(Enumerable.SequenceEqual(correctIntensities, BasePeak1LastRetentionTimesAndIntensities.Intensities));
        }
        ...
        public void StartTimesCorrectIfOneBasePeak()
        {
            ...
            Assert.IsTrue(Enumerable.SequenceEqual(correctST, BasePeak1LastRetentionTimesAndIntensities.StartTimes));
        }
